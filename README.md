...
$ git clone https://github.com/alura-cursos/spaceapp-web.git
...
```bash
# Execute em outro terminal (dentro da pasta spaceapp-web)
$ npm run dev
```
...
Para acessar ao projeto mobile, acesse o repositório [SpaceApp Mobile](https://github.com/alura-cursos/react-native-firebase-notification/) e siga as instruções de instalação.
